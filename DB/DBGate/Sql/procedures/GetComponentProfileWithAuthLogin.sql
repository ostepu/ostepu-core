...
CREATE PROCEDURE `DBGateGetComponentGateProfileWithAuthLogin` (IN profile varchar(30), IN authProfile varchar(30), IN ruleProfile varchar(30), IN profName varchar(30), IN authType varchar(120), IN component varchar(120), IN login varchar(120))
READS SQL DATA
begin
SET @s = concat("
select SQL_CACHE
