...
ALTER IGNORE TABLE `ExerciseSheet` MODIFY COLUMN ES_startDate INT UNSIGNED NULL DEFAULT 0;
ALTER IGNORE TABLE `ExerciseSheet` MODIFY COLUMN ES_endDate INT UNSIGNED NULL DEFAULT 0;
ALTER IGNORE TABLE `ExerciseSheet` MODIFY COLUMN ES_groupSize SMALLINT UNSIGNED NULL DEFAULT 1;
