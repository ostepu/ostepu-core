<?php
/**
 * @file GetTutorCourseMarkings.sql
 *
...
CREATE PROCEDURE `DBMarkingGetTutorCourseMarkings` (IN courseid INT,IN userid INT,IN sub varchar(12))
READS SQL DATA
begin
SET @s = concat("
select SQL_CACHE
...
from
    Marking M
        join
    ExerciseSheet ES ON (M.ES_id = ES.ES_id and ES.C_id = '",courseid,"')
        join
