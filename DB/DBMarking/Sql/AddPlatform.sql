...
ALTER IGNORE TABLE `Marking` MODIFY COLUMN M_tutorComment VARCHAR(255) NULL;
ALTER IGNORE TABLE `Marking` MODIFY COLUMN M_status TINYINT NOT NULL DEFAULT 0;
ALTER IGNORE TABLE `Marking` MODIFY COLUMN M_hideFile TINYINT NOT NULL DEFAULT 0;
ALTER IGNORE TABLE `Marking` MODIFY COLUMN M_date INT UNSIGNED NULL DEFAULT 0;
