...
/**
 * @file DBExerciseTypeTest.php contains the DBExerciseTypeTest class
 *
 * @author Till Uhlig
 */
...
class DBExerciseTypeTest extends PHPUnit_Framework_TestCase
{
    ...
    public function GetExerciseType( )
    {
        ...
        $result = Request::get( 
                               $this->url . 'DBExerciseType/exercisetype/AAA',
                               array( 
                                     'SESSION: abc',
                                     'USER: 3',
                                     'DATE: ' . time( )
    ...
    public function AddExerciseType( )
    {
        $result = Request::delete( 
                                  $this->url . 'DBExerciseType/exercisetype/100',
                                  array( 
                                        'SESSION: abc',
                                        'USER: 3',
                                        'DATE: ' . time( )
        ...
        $obj = ExerciseType::createExerciseType( 
                                                '100',
                                                'Sonderpunkte'
                                                );
    ...
    public function DeleteExerciseType( )
    {
        ...
        $this->assertEquals( 
                            201,
                            $result['status'],
                            'Unexpected HTTP status code for DeleteExerciseType call'
                            );
    ...
    public function EditExerciseType( )
    {
        ...
        $this->assertEquals( 
                            201,
                            $result['status'],
                            'Unexpected HTTP status code for EditExerciseType call'
                            );
