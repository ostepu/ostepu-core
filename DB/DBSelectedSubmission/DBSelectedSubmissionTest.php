...
class DBSelectedSubmissionTest extends PHPUnit_Framework_TestCase
{
    ...
    public function GetSheetSelected( )
    {
        ...
        $this->assertContains( 
                              '{"leaderId":"1","submissionId":"2","exerciseId":"1"}',
                              $result['content']
                              );
    ...
    public function AddSelectedSubmission( )
    {
        ...
        $this->assertEquals( 
                            201,
                            $result['status'],
                            'Unexpected HTTP status code for AddSelectedSubmission call'
                            );
        ...
        $result = Request::post( 
                                $this->url . 'DBSelectedSubmission/selectedsubmission',
                                array( 
                                      'SESSION: abc',
                                      'USER: 3',
                                      'DATE: ' . time( )
                                      ),
                                SelectedSubmission::encodeSelectedSubmission( $obj )
                                );
        $this->assertEquals( 
                            201,
                            $result['status'],
    ...
    public function DeleteSelectedSubmission( )
    {
        ...
        $this->assertEquals( 
                            201,
                            $result['status'],
                            'Unexpected HTTP status code for DeleteSelectedSubmission call'
                            );
    ...
    public function EditSelectedSubmission( )
    {
        ...
        $this->assertEquals( 
                            201,
                            $result['status'],
                            'Unexpected HTTP status code for EditSelectedSubmission call'
                            );
