...
ALTER TABLE `Submission` MODIFY COLUMN S_comment VARCHAR(255) NULL;
ALTER TABLE `Submission` MODIFY COLUMN F_id_file INT NULL;
ALTER TABLE `Submission` MODIFY COLUMN S_date INT UNSIGNED NOT NULL DEFAULT 0;
ALTER TABLE `Submission` MODIFY COLUMN S_flag TINYINT NOT NULL DEFAULT 1;
ALTER TABLE `Submission` MODIFY COLUMN S_hideFile TINYINT NOT NULL DEFAULT 0;
