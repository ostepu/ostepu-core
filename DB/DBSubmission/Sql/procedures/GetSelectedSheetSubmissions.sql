...
CREATE PROCEDURE `DBSubmissionGetSelectedSheetSubmissions` (IN profile varchar(30), IN selectedSubmissionProfile varchar(30), IN fileProfile varchar(30), IN esid INT)
READS SQL DATA
begin
SET @s = concat("
select SQL_CACHE
