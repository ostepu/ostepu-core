...
CREATE PROCEDURE `DBSubmissionGetGroupCourseSubmissions` (IN profile varchar(30), IN selectedSubmissionProfile varchar(30), IN fileProfile varchar(30), IN exerciseProfile varchar(30), IN groupProfile varchar(30), IN userid INT,IN courseid INT)
READS SQL DATA
begin
SET @s = concat("
select SQL_CACHE
