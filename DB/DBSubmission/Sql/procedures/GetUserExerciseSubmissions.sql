...
CREATE PROCEDURE `DBSubmissionGetUserExerciseSubmissions` (IN profile varchar(30), IN selectedSubmissionProfile varchar(30), IN fileProfile varchar(30), IN userid INT,IN eid INT)
READS SQL DATA
begin
SET @s = concat("
select SQL_CACHE
