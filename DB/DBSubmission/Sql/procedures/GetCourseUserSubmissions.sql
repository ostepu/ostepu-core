...
CREATE PROCEDURE `DBSubmissionGetCourseUserSubmissions` (IN profile varchar(30), IN selectedSubmissionProfile varchar(30), IN fileProfile varchar(30), IN courseid INT,IN userid INT)
READS SQL DATA
begin
SET @s = concat("
select SQL_CACHE
