<?php
/**
 * @file GetSelectedExerciseSubmissions.sql
 *
...
CREATE PROCEDURE `DBSubmissionGetSelectedExerciseSubmissions` (IN profile varchar(30), IN selectedSubmissionProfile varchar(30), IN fileProfile varchar(30), IN eid INT)
READS SQL DATA
begin
SET @s = concat("
select SQL_CACHE
