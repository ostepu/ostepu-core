...
class DBCourseTest extends PHPUnit_Framework_TestCase
{
    ...
    public function DeleteCourse( )
    {
        ...
        $this->assertEquals( 
                            201,
                            $result['status'],
                            'Unexpected HTTP status code for DeleteCourse call'
                            );
    ...
    public function EditCourse( )
    {
        ...
        $this->assertEquals( 
                            201,
                            $result['status'],
                            'Unexpected HTTP status code for EditCourse call'
                            );
