...
DROP PROCEDURE IF EXISTS `DBTransactionGetTransactionShort`;
CREATE PROCEDURE `DBTransactionGetTransactionShort` (IN profile varchar(30), IN courseid INT, IN tid INT, IN random varchar(32))
READS SQL DATA
begin
SET @s = concat("
select
