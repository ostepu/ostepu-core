...
/**
 * @file DBAttachmentTest.php contains the DBAttachmentTest class
 *
 * @author Till Uhlig
 */
...
/**
 * A class, to test the DBAttachment component
 */
class DBAttachmentTest extends PHPUnit_Framework_TestCase
{
    ...
    public function AddAttachment( )
    {
        $result = Request::delete( 
                                  $this->url . 'DBAttachment/attachment/100',
                                  array( 
                                        'SESSION: abc',
                                        'USER: 3',
                                        'DATE: ' . time( )
        ...
        $this->assertEquals( 
                            201,
                            $result['status'],
                            'Unexpected HTTP status code for AddAttachment call'
                            );

        // createAttachment($attachmentId,$exerciseId,$fileId)
        $obj = Attachment::createAttachment( 
                                            '100',
                                            '1',
                                            '1'
                                            );
        ...
        $result = Request::post( 
                                ...
                                Attachment::encodeAttachment( $obj )
                                );
        $this->assertEquals( 
                            201,
                            $result['status'],
    ...
    public function DeleteAttachment( )
    {
        ...
        $this->assertEquals( 
                            201,
                            $result['status'],
                            'Unexpected HTTP status code for DeleteAttachment call'
                            );
    ...
    public function EditAttachment( )
    {
        ...
        $this->assertEquals( 
                            201,
                            $result['status'],
                            'Unexpected HTTP status code for EditAttachment call'
                            );
