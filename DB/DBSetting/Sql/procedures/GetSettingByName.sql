...
DROP PROCEDURE IF EXISTS `DBSettingGetSettingByName`;
CREATE PROCEDURE `DBSettingGetSettingByName` (IN profile varchar(30), IN courseid INT, IN setname varchar(30))
READS SQL DATA
begin
SET @s = concat("
select
