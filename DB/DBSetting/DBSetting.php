...
class DBSetting
{
    ...
    */
    ...
    {   
        ...
        $profiles['readonly']->addRule(GateRule::createGateRule(null,'httpCall',$myName,'GET /setting/:path+',null));
        
        $profiles['general'] = GateProfile::createGateProfile(null,'general');
        $profiles['general']->setRules($profiles['readonly']->getRules());
        $profiles['general']->addRule(GateRule::createGateRule(null,'httpCall',$myName,'DELETE /setting/:path+',null));
        $profiles['general']->addRule(GateRule::createGateRule(null,'httpCall',$myName,'PUT /setting/:path+',null));
        $profiles['general']->addRule(GateRule::createGateRule(null,'httpCall',$myName,'POST /setting/:path+',null));
