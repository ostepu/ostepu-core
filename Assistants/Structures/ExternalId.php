...
class ExternalId extends Object implements JsonSerializable
{
    ...
    public function getInsertData(){
        ...
        if ($this->id != null) $this->addInsertData($values, 'EX_id', mysql_real_escape_string($this->id));
        if ($this->course != null) $this->addInsertData($values, 'EX_course', mysql_real_escape_string($this->course->getId()));
