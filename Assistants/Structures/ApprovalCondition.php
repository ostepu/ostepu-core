...
class ApprovalCondition extends Object implements JsonSerializable
{
    ...
    public function getInsertData(){
        ...
        if ($this->id != null) $this->addInsertData($values, 'AC_id', mysql_real_escape_string($this->id));
        if ($this->courseId != null) $this->addInsertData($values, 'C_id', mysql_real_escape_string($this->courseId));
        if ($this->exerciseTypeId != null) $this->addInsertData($values, 'ET_id', mysql_real_escape_string($this->exerciseTypeId));
        if ($this->percentage != null) $this->addInsertData($values, 'AC_percentage', mysql_real_escape_string($this->percentage));
