...
include_once ( dirname( __FILE__ ) . '/Structures/GateAuth.php' );
include_once ( dirname( __FILE__ ) . '/Structures/GateProfile.php' );
include_once ( dirname( __FILE__ ) . '/Structures/GateRule.php' );
