 ...
 */
 ...
 ?>
       ...
       <td><input type="checkbox" class="parameter-choice" name="exercises[0][subexercises][0][processorParameterList][0][]" value="isalphanum"/></td><td><label class="label bold">Buchstaben+Ziffern</label></td>
        ...
        <tr><td colspan="6"><label class="label bold">regulärer Ausdruck: </label> <input type="text" class="parameter-choice" name="exercises[0][subexercises][0][processorParameterList][0][]" value=""/ placeholder="%^([0-9]{5})$%"></td></tr>
        </table>
            </div>
            </div>