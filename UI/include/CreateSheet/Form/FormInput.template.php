...
<input type="hidden" class="input-choice" name="exercises[0][subexercises][0][correct][0]" value="1"><input class="form-field input-choice-text" style="width:100%" name="exercises[0][subexercises][0][choice][0]" value="" placeholder="Musterlösung"/>    
</div>
