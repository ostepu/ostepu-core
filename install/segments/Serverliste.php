...
class Serverliste
{
    ...
    public static function showInfoBar(&$data)
    {
        ...
        echo "<tr><td class='e'>".Language::Get('serverList','serverList',self::$langTemplate)."</td></tr>";
        ...
        if (Einstellungen::$accessAllowed){
            echo "<tr><td class='v'>".Design::erstelleSubmitButtonFlach('actionAddServer','OK',Language::Get('serverList','addServer',self::$langTemplate).">")."</td></tr>";
        }
