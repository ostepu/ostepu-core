...
class FSFile
{
    ...
    {   
        ...
        $profiles['readonly']->addRule(GateRule::createGateRule(null,'httpCall',$myName,'GET /file/:a/:b/:c/:file',null));
        $profiles['readonly']->addRule(GateRule::createGateRule(null,'httpCall',$myName,'GET /file/:a/:b/:c/:file/:filename',null));
        
        $profiles['general'] = GateProfile::createGateProfile(null,'general');
        $profiles['general']->setRules($profiles['readonly']->getRules());
        $profiles['general']->addRule(GateRule::createGateRule(null,'httpCall',$myName,'DELETE /file/:a/:b/:c/:file',null));
        $profiles['general']->addRule(GateRule::createGateRule(null,'httpCall',$myName,'POST /file/:filename',null));
        $profiles['general']->addRule(GateRule::createGateRule(null,'httpCall',$myName,'POST /file',null));
