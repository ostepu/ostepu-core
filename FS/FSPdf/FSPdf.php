...
class FSPdf
{
    ...
    {   
        ...
        $profiles['general']->addRule(GateRule::createGateRule(null,'httpCall',$myName,'POST /:folder/:filename',null));
        $profiles['general']->addRule(GateRule::createGateRule(null,'httpCall',$myName,'POST /:folder/:type/:a/:b/:c/:file',null));
        $profiles['general']->addRule(GateRule::createGateRule(null,'httpCall',$myName,'POST /:folder/file',null));
        $profiles['general']->addRule(GateRule::createGateRule(null,'httpCall',$myName,'POST /:folder/file/merge',null));
        $profiles['general']->addRule(GateRule::createGateRule(null,'httpCall',$myName,'POST /:folder',null));
